...
exports.deleteDeployment = exports.createDeployment = exports.getAllDeployments = void 0;
var deployment_modal_1 = __importDefault(require("../modals/deployment.modal"));
/**
    ...
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, deployment_modal_1.default.find({})];
                case 1:
                    deployments = _a.sent();
                    resolve(deployments);
                    return [3 /*break*/, 3];
 ...
 */
var createDeployment = function (data) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var deployment, saved_deployment, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    deployment = new deployment_modal_1.default(data);
                    return [4 /*yield*/, deployment.save()];
                case 1:
                    saved_deployment = _a.sent();
...
var deleteDeployment = function (id) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var deleteInfo, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, deployment_modal_1.default.findByIdAndDelete(id)];
                case 1:
                    deleteInfo = _a.sent();
                    resolve(deleteInfo);
                    return [3 /*break*/, 3];
